...
module.exports = (function () {
    ...
    function add(song) {
        var songFromNotYetPlayedSongs = getSongFromNotYetPlayedSongs(song.id);
    ...
    function getSongFromNotYetPlayedSongs(songId) {
        return lazy(player._list).slice(getIndexOfNextPlayingSong()).find(function (song) {
    ...
    function printNotYetPlayedSongs() {
        lazy(player._list).slice(getIndexOfNextPlayingSong()).each(function (currentSong, index) {
